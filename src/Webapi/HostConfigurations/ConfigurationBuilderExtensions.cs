...
internal static class ConfigurationBuilderExtensions
{
	public static IConfigurationBuilder AddCustomBootstrapConfiguration(
		...
		configurationBuilder
			...
			.AddIf(
				args is not null,
				x => x.AddCommandLine(args ?? Array.Empty<string>()));
	...
	public static IConfigurationBuilder AddIf(this IConfigurationBuilder configurationBuilder, bool condition, Func<IConfigurationBuilder, IConfigurationBuilder> action)
	{
		ArgumentNullException.ThrowIfNull(configurationBuilder, "configurationBuilder");
